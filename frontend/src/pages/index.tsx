...
const IndexPage = ({ status, user, signout }) => {
  if (status === 'in' || !!user) {
    console.log(user)
    return (
      <div>
      ...
      <section className="how-does-it-work">
        <div className="wrapper">
          ...
          <ol>
            ...
            <li>
              Each time your Zap is triggered, we’ll plant a tree on your
              behalf.
            </li>
          </ol>
        </div>
        ...
        <div className="wrapper">
          ...
          <div>
            <p style={{ maxWidth: '900px' }}>
              Eden Projects hire local people in Indonesia and Madagascar to
              plant native trees around their communities, supporting local
